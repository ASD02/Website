...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.timeline-item, .project-card, .award-card, .skill-category, .contact-item');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    timelineItems.forEach(item => {
        ...
        item.addEventListener('mouseleave', () => {
            ...
            item.querySelector('.timeline-content').style.boxShadow = '0 10px 30px rgba(0, 0, 0, 0.1)';
        });
    });
});
...
// Add print button event listener if you add a print button
document.addEventListener('DOMContentLoaded', () => {
...
console.log(`
🚀 Welcome to Adith Devakonda's Portfolio!
📧 Contact: adithdevakonda@gmail.com
💼 GitHub: https://github.com/ASD02
🏠 Location: Suwanee, GA
`);
